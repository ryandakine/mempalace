...
from mempalace.config import CHROMA_COLLECTION_METADATA, MempalaceConfig  # noqa: E402
...
def collection(palace_path):
    ...
    col = client.get_or_create_collection("mempalace_drawers", metadata=CHROMA_COLLECTION_METADATA)
    yield col
